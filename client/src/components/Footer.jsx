  ...
  return (
    <Flex direction='row' backgroundImage= 'linear-gradient(60deg,#29323c 0%, #485563 100%)' color='white' p='50px' mt='10px'>
        <Box flexBasis='40%'>
            ...
            <Text mb='4'>Spinny is the most trusted way of buying and selling used cars. 
                Choose from over 5000 fully inspected second-hand car models. 
                Select online and book a test drive at your home or at a Spinny Car Hub near you. 
                Get a no-questions-asked 5-day money back guarantee and a free one-year 
                comprehensive service warranty with Assured Resale Value on every Spinny car.
            </Text>
            <HStack py={2} mb='4'>
            ...
            <Text>Copyleft &copy; TradeCars, All rights reserved</Text>
        </Box>
        <Box ml={10}>
        ...
        <Button alignSelf='center' justifySelf='center' flex='1' ml={10} size='lg' variant='outline' color='white' _hover={{color: 'black', bg:'white'}}>Contact Us</Button>
    </Flex>
  )
}
